...
```bash
git remote add encore encore://mental-health-platform-5sqi
```
...
Monitor your deployment progress in the [Encore Cloud dashboard](https://app.encore.dev/mental-health-platform-5sqi/deploys).
...
2. Navigate to Encore Cloud [GitHub Integration settings](https://app.encore.cloud/mental-health-platform-5sqi/settings/integrations/github)
